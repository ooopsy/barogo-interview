package com.li.delivery.common.config;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.li.delivery.common.contants.ResultCode;
import com.li.delivery.util.JwtRequestFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        .authenticationEntryPoint((request, response, authException) -> {
            ...
            responseMap.put("code", ResultCode.NO_AUTHRORIZATION.getCode());
            responseMap.put("codeName", ResultCode.NO_AUTHRORIZATION);
            responseMap.put("desc", "Unauthorized");
            responseMap.put("message", "Unauthorized");
            responseMap.put("resultData", "Unauthorized");
